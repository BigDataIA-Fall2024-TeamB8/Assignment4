...
with Diagram("Research Tool Architecture for Assignment 4", show=True, direction="LR"):
    ...
    with Cluster("Research Agent System"):
        langraph = Custom("Langraph(RAG model)", langraph_icon_path)
...
# Path to custom icons
docling_icon_path = "/content/Docling.png"  # Replace with the path for Docling icon
pinecone_icon_path = "/content/Pinecone.png"  # Replace with the path for Pinecone icon
langraph_icon_path = "/content/Langraph.png"  # Replace with the path for Langraph icon
streamlit_icon_path = "/content/streamlit.png"  # Replace with the path for Streamlit icon
pdf_icon_path = "/content/PDF_Report.png"  # Replace with the path for PDF report icon
agent_ai_icon_path = "/content/AgentAI.png"  # Replace with the path for Agent AI icon
